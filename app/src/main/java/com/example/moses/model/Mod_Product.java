...
public class Mod_Product {
    ...
    public Mod_Product(String pType, String pPrice, String pDesc, String pDate, String pImage, String pId, String pDeliver, String pWeight) {
        this.pType = pType;
        this.pPrice = pPrice;
        this.pDesc = pDesc;
        this.pDate = pDate;
